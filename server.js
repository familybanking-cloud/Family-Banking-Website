...
app.post("/api/admin-data", (req, res) => {
  // Expecting full object: {members, weekly, withdrawals, loans}
...
app.get("/api/member-data/:username", (req, res) => {
  ...
  // IMPORTANT: admin enters member usernames in transactions
...
// ---------- HTML routes (optional; static also works) ----------
